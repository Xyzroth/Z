...
if (command == 'whmods3') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `shadowblackhacking3@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://www.tiktok.com/@xyzroth?_t=8WiZZ7JZlS6&_r=1`, `👤 Gada pawang nih senggol dong 😔`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://github.com/Xyzroth/`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
